    ...
    coach && !loading ? (
      <div ref={coachRef} className="scroll-mt-24 space-y-4">
        ...
        <div className="glass-card space-y-4 p-5 sm:p-6">
          <div className="text-balance-ko space-y-3">
            <h3 className="font-display text-xl font-semibold leading-snug text-brand-ink dark:text-white">
              {coach.summary}
            </h3>
            <p className="leading-relaxed text-brand-ink/90 dark:text-white/80">{coach.advice}</p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="rounded-2xl bg-black/[0.03] px-4 py-3 dark:bg-white/5">
                ...
                <p className="mt-1 text-sm text-brand-ink dark:text-white/80">
                  ...
                  kcal · P{' '}
                  {coach.stats.projected_daily_protein != null && coach.stats.projection_usable
                    ? coach.stats.projected_daily_protein
                    : coach.stats.avg_daily_protein}
                  g · C {coach.stats.avg_daily_carbs}g · F {coach.stats.avg_daily_fat}g
                </p>
                {!!coach.stats.fills_unlogged_meals &&
